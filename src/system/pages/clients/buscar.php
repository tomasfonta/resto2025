...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header hidden-xs hidden-sm">Buscar Productos</h1> 
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                		...
                                		$sentence = "SELECT * FROM products JOIN category ON category.category_id = products.product_category JOIN users ON users.user_id = products.product_owner";
                                		...
                                		if($rows > 0)
                                		{
                                			while($row = mysqli_fetch_assoc($result))
                                			{
                                                ...
                                                echo "    <td>$date</td>";
                                                echo "    <td><a href=home.php?pagina=perfil&id=$ownerid>$ownerName</a></td>";
                                                echo "    <td>$priceok</td>";
                                                echo "</tr>";
                                                ...
                                                <td>
                                                    <div class=\"col-lg-12\">
                                                        <div class=\"panel panel-primary\">
                                                            ...
                                                            <div class=\"panel-body\">
                                                                <p>Marca: $brand  -   Dimension: $dimension  -   Ultima Edicion: $date</br>
                                                                Proveedor: <a href=\"home.php?pagina=perfil&id=$ownerid\">$ownerName</a></p>
                                                            </div>
