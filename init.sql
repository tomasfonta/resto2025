...
INSERT INTO users (user_type, user_loginname, user_location, user_telephone1, user_telephone2, user_cellphone1, user_cellphone2, user_contactemail, user_website, user_name, user_description, user_photo, user_type_boolean, user_password, user_count)
VALUES ('Supplier', 'maria_perez', 'Rosario, Argentina', '341-555-1234', '341-555-5678', '341-555-9012', NULL, 'maria.perez@example.com', 'www.example.com/mariaperez', 'Maria Perez', 'A leading supplier of restaurant food products in Rosario.', 'maria_perez.jpg', 1, 'password123', 0);

-- Insert dummy data into 'offers'
INSERT INTO offers (offer_name, offer_dimension, offer_brand, offer_minimun, offer_time, offer_price, offer_date, offer_owner)
VALUES ('Special Offer on Rice', '1kg', 'Arroz Gallo', 50, '08:00:00', 120.50, '2024-07-28', 1);
...
INSERT INTO products (product_name, product_dimension, product_brand, product_price, price, product_date, product_owner, product_category)
VALUES ('Premium Olive Oil', '1kg', 'Olivares del Sur', 250.00, 220.00, '2024-07-28', 1, 1);


-- Insert dummy data into 'requests'
INSERT INTO requests (request_name, request_dimension, request_brand, category_name, request_owner)
VALUES ('Request for Flour', '1kg', 'Harinas Rosario', 'Food Supplies', 1);
